...
const buildPrompt = (text: string) => {
  return `Анализируй текст как эксперт. Выдели ключевые тезисы.
...
Пример ответа:
[
    {"question": "Какой главный вывод из текста?","answer":"Главный вывод в том, что..."},
    {"question": "Какой пример иллюстрирует основную идею?","answer":"Примером может служить..."},
]
